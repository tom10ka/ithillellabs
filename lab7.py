...
item_1_price = Decimal(item_1_price).quantize(Decimal('1.00'))
item_1_quantity = Decimal(item_1_quantity).quantize(Decimal('1'))
...
item_2_price = Decimal(item_2_price).quantize(Decimal('1.00'))
item_2_quantity = Decimal(item_2_quantity).quantize(Decimal('1'))
